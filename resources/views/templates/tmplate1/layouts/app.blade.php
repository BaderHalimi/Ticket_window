...
<body class="font-sans">
    ...
    <header class="fixed top-0 end-0 z-[100]">
        <div class="flex items-center justify-end p-3 space-x-4 rtl:space-x-reverse">
            ...
            <!-- زر الحساب -->
            <a href="{{ route('customer.login',['redirect' => url()->current()]) }}" class="w-10 h-10 bg-black text-white rounded flex items-center justify-center hover:opacity-80 transition">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <footer class="bg-gray-900 text-white py-10">
        <div class="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
                ...
                <p class="text-sm">وصف قصير عن النشاط التجاري أو خدماته المميزة.</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p class="text-sm">الإيميل: contact@rbusniess.com</p>
            </div>
        </div>
        <div class="text-center text-xs text-gray-400 mt-6">
            جميع الحقوق محفوظة لدى <a class="text-orange-500" href="{{ config('app.url') }}">{{ config('app.name') }} © 2025 </a>
        </div>
    </footer>
