<div class="flex align-center justify-center h-[100vh]">
    <div class="mx-auto w-full max-w-3xl h-[90vh] bg-white shadow-xl rounded-3xl overflow-hidden ring-1 ring-gray-200 flex flex-col">
        ...
        <div class="flex items-center gap-4 p-4 border-b">
            ...
            <div class="flex-1">
                <h2 class="text-lg font-bold text-gray-800">
                    {{ auth()->guard('customer')->user()->f_name }} {{ auth()->guard('customer')->user()->l_name }}
                </h2>
                <p class="text-sm text-gray-500">{{ auth()->guard('customer')->user()->business_name }}</p>
                <p class="text-xs text-gray-400">{{ auth()->guard('customer')->user()->email }}</p>
            </div>
        </div>
