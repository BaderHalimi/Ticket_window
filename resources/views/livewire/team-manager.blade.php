<div class="max-w-4xl mx-auto p-6">
    ...
    <div class="bg-white shadow rounded-lg p-6 mb-6">
        ...
        <div class="px-4 py-2 bg-green-100 border-green-600 border rounded-md mb-4 text-green-600 font-medium flex items-center gap-2">
            {{ session('success') }}
        </div>
        @endif
        @if (session()->has('error'))
        <div class="px-4 py-2 bg-red-100 border-red-600 border rounded-md mb-4 text-red-600 font-medium flex items-center gap-2">
            {{ session('error') }}
        </div>
        @endif
