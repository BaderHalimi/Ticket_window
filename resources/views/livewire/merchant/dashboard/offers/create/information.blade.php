<form wire:submit.prevent="save">
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 gap-4">
            ...
            @if ($type != 'restaurant')
                <div>
                    <label class="block text-sm font-medium mb-1">{{ __('type') }} <span class="text-red-500"
            ...
            @if ($type == 'events')
                ...
                <div class="space-y-4">
                    ...
                    <div class="relative">
                        <i
                            class="ri-list-check text-gray-400 absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none"></i>
                    ...
                    <div class="relative">
                        <i
                            class="ri-checkbox-circle-line text-gray-400 absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none"></i>
            ...
            @if ($type == 'services')
                ...
                <div>
                    <label class="block text-sm font-medium mb-1">{{ __('centrality') }} <span class="text-red-500"
                            style="font-weight: bold;">*</span></label>
                ...
                <div class="space-y-4">
                    ...
                    <div class="relative">
                        <i
                            class="ri-settings-3-line text-gray-400 absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none"></i>
                        <select wire:model.lazy="services_type" id="service_name"
                            ...
                            @if ($category == 'medical')
                                <option value="online_medical_consulting">{{ __('online medical consulting') }}
                                </option>
                            ...
                            @if ($category == 'maintenance')
                                ...
                                <option value="agriculture_tools_repair">{{ __('agricultural tools repair') }}
                                </option>
                            @endif
