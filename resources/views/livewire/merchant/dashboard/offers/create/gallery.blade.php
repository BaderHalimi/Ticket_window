<div class="space-y-6">
    ...
    <div>
        ...
        @if ($offering->image)
            <img src="{{ asset('storage/'.$offering->image) ?? null}}" class="h-32 rounded-lg shadow">
        @endif
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
            @foreach ($gallery as $index => $imagePath)
                <div class="relative group">
                    <img src="{{ asset('storage/'.$index) ?? null }}" class="w-full h-28 object-cover rounded-md shadow">
