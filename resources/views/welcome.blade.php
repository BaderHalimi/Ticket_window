    ...
    <div class="hero-bg relative min-h-screen">
        ...
        <nav class="fixed top-0 left-0 w-full z-50 px-8 py-6 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-6">
                ...
                <a href="{{ Auth::user()?route('visitor.dashboard'):route('visitor.login') }}" class="nav-button bg-primary bg-opacity-20 px-6 py-3 rounded-full text-primary font-semibold tracking-wide !rounded-button whitespace-nowrap">{{ Auth::user()?'Dashboard':'Sign In' }}</a>
            </div>
        </nav>
