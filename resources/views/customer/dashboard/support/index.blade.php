...
<div class="max-w-6xl mx-auto mt-12 space-y-6">
    ...
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('support.create') }}" class="bg-blue-600 text-white text-sm px-4 py-2 rounded hover:bg-blue-700">
            + إضافة تذكرة جديدة
        </a>
    </div>
                ...
                @forelse ($tickets as $index => $ticket)
                    <tr>
                        ...
                        <td class="px-6 py-4">
                            ...
                            @else
                                <a href="{{ route('support.show', $ticket->id) }}" class="text-blue-600 hover:underline text-sm">عرض</a>
                            @endif
                        </td>
                    </tr>
                @empty
