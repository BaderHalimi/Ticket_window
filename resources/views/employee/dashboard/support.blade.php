    ...
    <div class="grid grid-cols-1 gap-4">
        ...
        <div class="glassmorphism rounded-xl p-4 flex justify-between items-center card-hover transition duration-300">
            ...
            <div class="flex items-center space-x-2 rtl:space-x-reverse">
                <!-- عرض -->
                <button class="text-blue-600 hover:text-blue-800" title="show">
                    <i class="ri-eye-line text-xl"></i>
                </button>
                
                <button class="text-purple-600 hover:text-purple-800" title="accept">
                    <i class="ri-checkbox-circle-line"></i>
                </button>

                <button class="text-purple-600 hover:text-purple-800" title="deny">
                ...
                <!-- عرض QR -->
                <button class="text-teal-600 hover:text-teal-800" title="show QR">
                    <i class="ri-qr-code-line text-xl"></i>
                </button>
                <!-- حذف -->
                <button class="text-red-600 hover:text-red-800" title="delet">
