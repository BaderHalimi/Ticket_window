...
<div class="max-w-5xl mx-auto py-12">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('employee.check.index') }}" class="gradient-button text-white px-4 py-2 rounded-lg shadow-md">
    ...
    <div class="glassmorphism p-10 rounded-lg shadow-lg grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <p class="text-gray-600 mb-2"><strong>Date :</strong> {{ \Carbon\Carbon::parse($event->date)->format('Y-m-d H:i A') }}</p>
            <p class="text-gray-600 mb-2"><strong>Location :</strong> {{ $event->location }}</p>
            <p class="text-gray-600 mb-2"><strong>Tickets :</strong> {{ $event->total_tickets }}</p>
            <p class="text-gray-600 mb-2"><strong>Tickets Price :</strong> {{ number_format($event->ticket_price, 2) }} ريال</p>
