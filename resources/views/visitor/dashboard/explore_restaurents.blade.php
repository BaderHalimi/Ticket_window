...
<div class="grid">
    ...
    <div>
        <!-- Search Section -->
        <div class="mb-10 max-w-2xl me-auto">
        ...
        <h2 class="text-xl font-semibold mb-6">Explore Restaurents</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6" id="carousel">
            <!-- Event Card 1 -->
            <div
