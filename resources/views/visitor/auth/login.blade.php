...
<head>
    ...
    <title>login - {{ config('app.name') }} Platform</title>
...
<body class="min-h-screen flex items-center justify-center px-4">
    ...
    <div class="max-w-xl w-full mx-auto">
        ...
        <div class="glassmorphism p-10 rounded-3xl">
            ...
            <form class="space-y-5" method="post" action="{{ route('visitor.login_logic') }}">
                @csrf
                <div>
                ...
                <button type="submit" class="w-full bg-primary text-white py-3 rounded-lg text-lg font-semibold">Sign In</button>
                ...
                <p class="text-center text-indigo-700 mt-4">Don't have an account?
                    <a href="{{ route('visitor.register') }}" class="text-primary font-semibold">Register</a>
                </p>
            </form>
        </div>
